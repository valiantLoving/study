    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    self = this;
                    return [4, self.findOne({ userId: userId }, options)];
...
PlayerSchema.statics.updatePlayer = function (targetUid, originInfo) {
    return __awaiter(this, void 0, void 0, function () {
        var targetPlayer, key;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, this.loadByUserId(targetUid)];
                case 1:
                    targetPlayer = _a.sent();
                    if (!targetPlayer) {
                    ...
                    for (key in originInfo.playerData._friendSys) {
...
exports.getModel = function (db) {
    var PlayerModel = db.model("player", PlayerSchema, "player");
    return PlayerModel;
};
